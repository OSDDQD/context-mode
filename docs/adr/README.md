...
| [0026](0026-one-supported-host.md) | One supported host — Codex removed in a deletion-only commit, the one-row registries kept, and the three properties that lost coverage written down |

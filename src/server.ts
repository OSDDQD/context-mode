...
import type { ToolDeps, ToolResult as ToolDepsResult } from "./tools/shared/deps.js";
 ...
 * `_detectedAdapter` in particular is still null at import time.
 */
function toolDeps(): ToolDeps {
  return {
    ...
    extractSnippet,
    semanticStatusHint,
    detectedAdapter: () => _detectedAdapter,
    searchFloodGuard,
    searchFloodGuardKey,

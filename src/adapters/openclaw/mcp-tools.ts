...
export const OPENCLAW_TOOL_DEFS: readonly OpenClawToolDef[] = [
  {
    name: "ctx_execute",
    description:
      "Execute code in a separate subprocess. Only stdout enters context. Prefer over Bash for any command producing >20 lines.",
    parameters: {
      type: "object",
      properties: {
  ...
  },
  {
    ...
    description:
      "Execute code with a file path. Only printed summary enters context — raw file stays in the subprocess.",
    parameters: {
      type: "object",
      properties: {
